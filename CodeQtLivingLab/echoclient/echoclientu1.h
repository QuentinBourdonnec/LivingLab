#ifndef ECHOCLIENTU1_H
#define ECHOCLIENTU1_H
...
/**
 * \file echoclientu1.h
 * \brief Gestion du premier utilisateur
...
/**
 * \class EchoClient
 * \brief class qui gere les donnees de l'utilisateur de la premiere piece d'ip 192.168.199.30, ip récupérée précedemment dans le main
 */
class EchoClientU1 : public QObject
{
    Q_OBJECT
public:
    /**
     * \brief methode principale de la classe EchoClient permettant de se connecter au serveur
     * \param url : prend l'adresse ip et le port de l'a piece 1'utilisateur 1
     */
    explicit EchoClientU1(const QUrl &url,  QObject *parent = Q_NULLPTR);
...
private Q_SLOTS:
     ...
     * \param var1 : le nombre de pas de l'utilisateur 1
