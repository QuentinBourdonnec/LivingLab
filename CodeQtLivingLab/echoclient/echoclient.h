...
/**
 * \file echoclient.h
 * \brief Gestion de la premiere piece
...
/**
 * \class EchoClient
 * \brief class qui gere les donnees de la premiere piece d'ip 192.168.199.30, ip récupérée précedemment dans le main
 */
...
public:
     ...
     * \param url : prend l'adresse ip et le port de la piece 1
     */
...
private Q_SLOTS:
     ...
     * \param var1 : le taux de CO2 de la première pièce
     * \param var2 : la température de la première pièce
     * \param var3 : l'humidité de la première pièce
     * \param var4 : la chute de la première pièce (valeur booléenne, 0 si rien, 1 si présence de chute)
     * \param var5 : le four de la première pièce (valeure booléenne, 0 si le four est éteint, 1 si il est allumé)
     * \param var6 : la date et l'heure en TIMESTAMP
     * \param var7 : L'utilisateur de la première piece, ici son adresse email
     */
